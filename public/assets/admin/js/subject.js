$(document).ready(function() {
    ...
    function addSubject() {
        ...
        var subject_short_name = $.trim($("#subject_short_name").val());
        ...
        if (subject_short_name == '') {
            error.push('Please enter the subject short url name');
        }
        if (original_price == '') {
        ...
        formdata.append('subject_short_name', subject_short_name);
