...
<head>
    ...
    <script type="text/javascript" src="<?=base_url()?>assets/js/custom_js/student_auth.js?v=1.0.0"></script>
...
<body>
    <div class="forgotPasswordContainer">
        <div class="registration-form">
            ...
            <a class="btn btn-class has-before forgotPassBtn mb-2 authButton" style="display: flex; align-items: center;">
                <span class="span">OTP</span>
                <ion-icon name="arrow-forward-outline"></ion-icon>
            </a>
            <!-- <button class="btn btn-block verifyOTP mb-2 authButton" style="display:none;">Verify OTP</button> -->
            <a class="btn btn-class has-before verifyOTP mb-2 authButton" style="display:none;">
                <span class="span">Verify OTP</span>
                <ion-icon name="arrow-forward-outline"></ion-icon>
            </a>
        </div>
    </div>
