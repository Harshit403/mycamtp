...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/cdn/css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/cdn/css/adminlte.min.css">
...
<body class="hold-transition login-page">
	...
	<script type="text/javascript" src="<?=base_url()?>assets/cdn/js/adminlte.min.js"></script>
	<script type="text/javascript" src="<?=base_url()?>assets/cdn/js/bootbox.min.js"></script>
	<script type="text/javascript" src="<?=base_url()?>assets/admin/js/login.js?v=1.0.0"></script>
