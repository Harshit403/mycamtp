            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label for="subject_short_name" class="form-label">Subject Short Url</label>
                            <input type="text" class="form-control form-control-sm" id="subject_short_name" placeholder="Subject Short Url" value="<?=!empty($fetchSubjectRow) ? $fetchSubjectRow->subject_short_name : ''?>">
                        </div>
                        <div class="col-md-6">
...
<script type="text/javascript" src="<?=base_url()?>//assets/admin/js/subject.js?v=1.0.1"></script>
<?= $this->endSection() ?>