...
<script src="<?=base_url()?>/assets/admin/design_assets/vendor/js/menu.js"></script>
<!-- endbuild -->
<!-- Vendors JS -->
<script src="<?=base_url()?>/assets/admin/design_assets/vendor/libs/apex-charts/apexcharts.js"></script>
<!-- Main JS -->
<script src="<?=base_url()?>/assets/admin/design_assets/js/main.js"></script>
<!-- Page JS -->
<script src="<?=base_url()?>/assets/admin/design_assets/js/dashboards-analytics.js"></script>
