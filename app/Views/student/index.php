...
<section class="header-text container py-5 m-2" id="intro-section" style="margin-top: 200px; position: relative; z-index: 2; background-color: white;">
    <h1 class="text-uppercase text-center" style="font-size: 3rem; color: green;">The Key of <span class="text-success">success</span></h1>
    <p style="font-size: 1.5rem;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
    consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
    cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
