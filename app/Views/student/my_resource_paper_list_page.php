...
<script>
    ...
    let fileExtension = fileUrl.split('.').pop().toLowerCase(); // File extension निकालो
    ...
    if (fileExtension === "pdf") {
        ...
        checkedButton.removeAttribute("download"); // Images के लिए download attribute हटाओ
        checkedButton.setAttribute("target", "_blank"); // Image नए tab में खुलेगी
    }
