                    ...
                    <?php foreach ($invoiceDetails as $value): ?>
                        <?php
                            ...
                            if (!empty($invoiceJson)) {
                                ...
                                ?>
                                <div class="col-md-12 mb-3" style="border: 1px solid;border-radius: 5px;">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="d-flex" style="flex-direction:column;">
                                            <pre><?=$jsonDecoded[0]->payment_status?></pre>
                                            <a href="<?=base_url()?>download-invoice?order_id=<?=$order_id?>" class="btn btn-sm btn-success mb-3 "><i class="bi bi-arrow-down-circle"></i> Download</a>
                                        </div>
                                    </div>
                                </div>
                                <?php
