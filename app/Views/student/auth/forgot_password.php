...
<body>
    <div class="container forgotPasswordContainer">
        ...
        <form>
            ...
            <div class="input-box inputBox">
                <input type="text" class="item" inputmode="numeric" required pattern="\d{6}" maxlength="6" oninput="this.value = this.value.replace(/\D/g, '')">
                <label>OTP</label>
            </div>
            <button type="submit" name="otp" id="otp" class="btn item authButton forgotPassBtn">Reset Password</button>
            <button type="submit" style="display:none;"> class="btn item authButton verifyOTP">Verify</button>
        </form>
