...
<body>
    ...
    <div class="signup_container" style="display: <?= ($addClass == 'login') ? 'none' : ''; ?>">
        <div class="registration-form">
            ...
            <p style= "font-size: 50%;">I have read <a href="https://missioncstestseries.com/terms-and-condition">Terms and conditions</a> and <a href="https://missioncstestseries.com/privacy-policy">Privacy Policy.</a></p>
