                        ...
                        <div class="col-md-3 <?=($i > 0) ? 'mb-2' : ''?>">
                            <div class="card" style="height: 10rem !important;">
                                <div class="card-body p-3">
                                    ...
                                    <a href="<?=base_url()?>amendment/amendment-list?subject=<?=$value->subject_short_name?>" class="stretched-link text-decoration-none"><h2 class="text-dark"><?=$value->subject_name?></h2></a>
                                </div>
                            </div>
                        </div>
                        <?php $i++;?>
